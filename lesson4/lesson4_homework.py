...
class Window(ThemedTk):
    def __init__(self,*args,**kwargs):
        ...
        btn1 = ttk.Button(bottomFrame,text="按鈕1")
        btn1.pack(side='top',expand=True,fill='x',padx=10,pady=30)
        btn2 = ttk.Button(bottomFrame,text="按鈕2")
        btn2.pack(side='top',expand=True,fill='x')
        btn3 = ttk.Button(bottomFrame,text="按鈕3")
        btn3.pack(side='top',expand=True,fill='x',padx=10)
        bottomFrame.pack(side='left',padx=10,pady=(10,0),ipadx=10,ipady=10,expand=True,fill='x')

        bottomFrame = ttk.Frame(self,width=500,height=300,borderwidth=1,relief='solid')
        btn1 = ttk.Button(bottomFrame,text="按鈕1")
        btn1.pack(side='top',expand=True,fill='x',padx=10,pady=20)
        btn2 = ttk.Button(bottomFrame,text="按鈕2")
        btn2.pack(side='top',expand=True,fill='x')
        btn3 = ttk.Button(bottomFrame,text="按鈕3")
        btn3.pack(side='top',expand=True,fill='x',padx=10,pady=20)
        bottomFrame.pack(side='left',padx=10,pady=(10,0),ipadx=10,ipady=10,expand=True,fill='x')

        bottomFrame = ttk.Frame(self,width=500,height=300,borderwidth=1,relief='solid')
        btn1 = ttk.Button(bottomFrame,text="按鈕1")
        btn1.pack(side='top',expand=True,fill='x',padx=10)
        btn2 = ttk.Button(bottomFrame,text="按鈕2")
        btn2.pack(side='top',expand=True,fill='x')
        btn3 = ttk.Button(bottomFrame,text="按鈕3")
        btn3.pack(side='top',expand=True,fill='x',padx=10)
